# Создание остальных файлов Chrome Extension

# 3. content.js - Content Script для взаимодействия с веб-страницами
content_js = '''
...
# 4. content.css - Стили для Content Script
content_css = '''
/* Стили для AI Assistant панели */
#ai-assistant-panel {
  position: absolute;
  width: 300px;
  background: white;
...
print("- content.js (Content Script для взаимодействия с веб-страницами)")
print("- content.css (стили для AI панели)")